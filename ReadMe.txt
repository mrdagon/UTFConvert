...
●使い方
　変換したいソースやヘッダーファイルをConvUTF.exeにドロップすると、文字が変換されます、変換後のソースをndk-buildして下さい。
...
直接UCN(\u3042)を記述している場合も変換が正しく行われません。
...
●ライセンス
　ConvUTFのライセンスはNYSL Version 0.9982です
...
●ライセンス補足
　ConvUTFで変換したソースファイルのライセンスがNYSL Version 0.9982になると言う事ではありません。
